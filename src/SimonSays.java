...
public class SimonSays extends KeyAdapter {
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.equals(imageIndex) && simonSays) {
		...
		if(e.equals(imageIndex) && !simonSays) {
			//////////////////RIUGHTUH HIDSOHIFODSHIFODSHIDFOSHFOFFFFFFFFFFFFFFF??????????????????!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		}
	...
	private void showImage() {
		...
		// "Simon says press this key" or "Press this key"
		 if(h==0) {
			 JOptionPane.showConfirmDialog(null, "S Say PRess");
			 simonSays=true;
		 }
		 else if (h==1) {
			 JOptionPane.showConfirmDialog(null, " PRess KEt");
			 simonSays=false;
